...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header text-dark fw-bold">Supplier</h5>
                    ...
                    <table id="myTable" class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-xs font-weight-bolder">Nama Supplier</th>
                                <th class="text-uppercase text-xs font-weight-bolder">Alamat</th>
                                <th class="text-uppercase text-xs font-weight-bolder">Nomor Telepon</th>
